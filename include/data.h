...
#define CANOPEN_NODE_DATA_INITIALIZER(NODE_PREFIX)                                               \
    {                              /* Object dictionary*/                                        \
     ...
     /* State machine*/                                                                          \
     Unknown_state,                                                                              \
     /* nodeState */ /* structure s_state_communication */                                       \
     {                                                                                           \
         0, /* csBoot_Up */                                                                      \
         0, /* csSDO */                                                                          \
         0, /* csEmergency */                                                                    \
     ...
     _heartbeatError,                        /* heartbeatError */                                \
                                                                                                 \
     {REPEAT_NMT_MAX_NODE_ID_TIMES(                                                              \
         NMTable_Initializer)}, /* is  well initialized at "Unknown_state". Is it ok ? (FD)*/    \
                                                                                                 \
     /* NMT-nodeguarding */                                                                      \
     ...
     &NODE_PREFIX##_obj1006,                                                                     \
     /* Sync_Cycle_Period */ /*& NODE_PREFIX ## _obj1007, */ /* Sync_window_length */            \
     ...
     &NODE_PREFIX##_obj1014,                                                                     \
     /* error_cobid */ /* error_data: structure s_errors */                                      \
